...
export default function Home(props) {
    return (
        <div className='min-h-[40rem] lg:px-40 lg:py-60 md:px-20 md:py-20 sm:px-10 sm:py-20 flex flex-row gap-20 items-center overflow-hidden lg:mt-[-3rem] md:mt-0 sm:mt-0'>
